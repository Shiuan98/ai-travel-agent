        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          ...
          <div class="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <a v-if="trip.flightLink" 
              :href="`http://localhost:3000/go?url=${encodeURIComponent(trip.flightLink)}&type=flight&source=tripcom&country=${country}`"
              target="_blank" 
              ...
              <div v-if="day.restaurants?.length" class="sm:col-span-2 lg:col-span-3 mt-4">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="r in day.restaurants" :key="r.name" class="place-card group flex flex-col h-full">
                      ...
                      <a :href="`http://localhost:3000/go?url=${encodeURIComponent(r.links.google)}&type=restaurant&source=google&country=${country}`"
                        target="_blank" 
                ...
                <div v-if="day.hotels?.length" class="sm:col-span-2 lg:col-span-3 mt-8">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="h in day.hotels" :key="h.name" class="place-card group flex flex-col h-full">
                      ...
                      <a :href="`http://localhost:3000/go?url=${encodeURIComponent(h.links.booking)}&type=hotel&source=booking&country=${country}`"
                        target="_blank" 
